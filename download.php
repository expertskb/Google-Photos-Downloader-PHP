...
$link = isset($_REQUEST['id']) ? $_REQUEST['id'] : null;
if (!$link) {
    header("Location: /");
} else {
                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <style>
                                        .iframe-loading {
                                            background: url("https://gkit.eu.org/png/loading.gif") center center no-repeat;
                                        }
                                    </style>
                                    <div class="row">
                                        <div class="col anonymous-box-container">
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="card-header">
                                                                <div class="row align-items-center">
                                                                    <div class="col">
                                                                        <h1 class="text-center">Your File is Ready, Click on Instant Download</h1>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div id="watch_button_hider" class="text-center">

                                                                <button style="" type="button" class="btn btn-primary" id="watch_button" data-toggle="modal" data-target="#privacyModal">Watch Online ▶</button>

                                                            </div>

                                                            <div id="player_load"></div>
                                                ...
                                                <div class="card-header border-0">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-12 text-center">
                                                            ...
                                                            <button style="" type="button" class="btn btn-primary" id="editPrivacyBtn" data-toggle="modal" data-target="#privacyModal" onclick="location.href='<?= $data['url']; ?>';">⚡ Instant Download ⚡</button>
                                    ...
                                    <script type="text/javascript">
                                        var watch_button_id = document.querySelector('#watch_button_hider');
                                        $("#watch_button").click(function() {

                                            watch_button_id.style.display = 'none';
                                            document.getElementById("player_load").innerHTML = '<div class="iframe-loading"><iframe src="<?= $data['eurl']; ?>" frameborder="0" width="100%" height="500" allowfullscreen="allowfullscreen" onload="$(\'.iframe-loading\').css(\'background-image\', \'none\');"></iframe></div>';
